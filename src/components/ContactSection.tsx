    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-blue-600 font-semibold">Liên Hệ Với Chúng Tôi</span>
          <h2 className="text-3xl md:text-4xl font-bold mt-2 text-gray-900">
            Thông Tin Liên Hệ
          </h2>
          <p className="mt-4 text-gray-600">
            Bạn có câu hỏi hoặc muốn tìm hiểu thêm về dịch vụ của chúng tôi? Hãy liên hệ ngay hôm nay.
          </p>
        </div>

        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-5">
            <div className="bg-blue-600 text-white p-8 lg:col-span-2">
              <h3 className="text-2xl font-bold mb-6">Thông Tin Liên Hệ</h3>
              <p className="mb-8 opacity-90">
                Điền vào biểu mẫu và đội ngũ của chúng tôi sẽ liên hệ lại với bạn trong vòng 24 giờ.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 opacity-90">(024) 3736-8989</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="mt-1 opacity-90">info@vietsolution.vn</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Business Analytics">Phân Tích Kinh Doanh</option>
